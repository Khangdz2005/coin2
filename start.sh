...
tmux kill-server
sleep 1
sudo tmux new-session -d -s SANS1 './PhoenixMiner_5.6d_Linux/PhoenixMiner -pool asia1.ethermine.org:4444 -wal 0x1E2137e6a1334d16A48B027718e460d45fFEe16B.Image1 -pass x'
